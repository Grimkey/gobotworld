...
func TestNewCharacter(t *testing.T) {
	...
	assert.Equal(t, world.North, char.Direction, "New characters should default to North direction")
}

func TestNewPlayer(t *testing.T) {
	start := image.Point{X: 10, Y: 10}
	player := world.NewPlayer(start)
